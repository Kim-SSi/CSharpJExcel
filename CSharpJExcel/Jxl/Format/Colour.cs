...
namespace CSharpJExcel.Jxl.Format
	...
	public class Colour
		...
		/**
		 * The display description for the colour.  Used when presenting the 
		 * format information
		 */
		...
		protected Colour(int val,string s,int r,int g,int b)
			...
			System.Array.Copy(oldcols,0,colours,0,oldcols.Length);
		...
		public static readonly Colour AUTOMATIC = new Colour(0x40,"automatic",0xff,0xff,0xff);
