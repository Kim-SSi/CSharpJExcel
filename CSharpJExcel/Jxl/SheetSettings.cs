...
namespace CSharpJExcel.Jxl
	...
	public sealed class SheetSettings
		 ...
		 */
		private bool pageBreakPreviewMode;
		 ...
		 */
		private bool verticalCentre;

		/**
		 * Horizontal centre flag
		 */
		private bool horizontalCentre;
		 ...
		 */
		private bool automaticFormulaCalculation;

		/**
		 * Recalculate the formulas before save
		 */
		private bool recalculateFormulasBeforeSave;
		...
		// The defaults
		// **
		private readonly PageOrientation DEFAULT_ORIENTATION = PageOrientation.PORTRAIT;
		private readonly PageOrder DEFAULT_ORDER = PageOrder.RIGHT_THEN_DOWN;
		private readonly PaperSize DEFAULT_PAPER_SIZE = PaperSize.A4;
		private const double DEFAULT_HEADER_MARGIN = 0.5;
		private const double DEFAULT_FOOTER_MARGIN = 0.5;
		private const int DEFAULT_PRINT_RESOLUTION = 0x12c;
		private const double DEFAULT_WIDTH_MARGIN = 0.75;
		private const double DEFAULT_HEIGHT_MARGIN = 1;

		private const int DEFAULT_DEFAULT_COLUMN_WIDTH = 8;
		private const int DEFAULT_ZOOM_FACTOR = 100;
		private const int DEFAULT_NORMAL_MAGNIFICATION = 100;
		private const int DEFAULT_PAGE_BREAK_PREVIEW_MAGNIFICATION = 60;

		// The publicly accessible values
		/**
		 * The default value for the default row height
		 */
		public const int DEFAULT_DEFAULT_ROW_HEIGHT = 0xff;
		 ...
		 */
		public void setProtected(bool p)
			{
			sheetProtected = p;
			}
		 ...
		 *
		 * @deprecated use overloaded version which takes a bool
		 */
		 ...
		 */
		public bool getDisplayZeroValues()
			{
		 ...
		 */
		public void setDisplayZeroValues(bool b)
			{
			displayZeroValues = b;
			}
		 ...
		 */
		public void setShowGridLines(bool b)
			{
			showGridLines = b;
			}
		 ...
		 */
		public bool getPageBreakPreviewMode()
			{
		 ...
		 */
		public void setPageBreakPreviewMode(bool b)
			{
		...
		*/
		public void setPrintGridLines(bool b)
			{
			printGridLines = b;
			}
		...
		*/
		public void setPrintHeaders(bool b)
			{
			printHeaders = b;
			}
		...
		public void setHorizontalFreeze(int row)
			{
			horizontalFreeze = System.Math.Max(row,0);
			}
		...
		public void setVerticalFreeze(int col)
			{
			verticalFreeze = System.Math.Max(col,0);
			}
		 ...
		 */
		public bool isHorizontalCentre()
			{
		 ...
		 */
		public void setHorizontalCentre(bool horizCentre)
			{
		 ...
		 */
		public void setVerticalCentre(bool vertCentre)
			{
		 ...
		 * FALSE otherwise
		 */
		public void setAutomaticFormulaCalculation(bool auto)
			{
		 ...
		 */
		public bool getAutomaticFormulaCalculation()
			{
		 ...
		 */
		public void setRecalculateFormulasBeforeSave(bool recalc)
			{
		 ...
		 * FALSE otherwise
		 */
		public bool getRecalculateFormulasBeforeSave()
			{
