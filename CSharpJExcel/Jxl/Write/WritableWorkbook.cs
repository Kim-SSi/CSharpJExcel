...
namespace CSharpJExcel.Jxl.Write
	...
	public abstract class WritableWorkbook
		 ...
		 */
		public static readonly WritableFont ARIAL_10_PT = new WritableFont(WritableFont.ARIAL);

		/**
		 * The font used for hyperlinks
		 */
		public static readonly WritableFont HYPERLINK_FONT = new WritableFont(WritableFont.ARIAL,
		 ...
		 */
		public static readonly WritableCellFormat NORMAL_STYLE = new WritableCellFormat(ARIAL_10_PT, NumberFormats.DEFAULT);

		/**
		 * The style used for hyperlinks
		 */
		public static readonly WritableCellFormat HYPERLINK_STYLE = new WritableCellFormat(HYPERLINK_FONT);

		/**
		 * A cell format used to hide the cell contents
		 */
		public static readonly WritableCellFormat HIDDEN_STYLE = new WritableCellFormat(new DateFormat(";;;"));
		 ...
		 */
		public abstract void setProtected(bool prot);
		 ...
		 * @exception IOException
		 */
		public abstract void setOutputFile(FileInfo fileName);
		}
	}
