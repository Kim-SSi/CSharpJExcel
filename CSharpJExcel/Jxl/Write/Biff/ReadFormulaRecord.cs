...
namespace CSharpJExcel.Jxl.Write.Biff
	 ...
	 * of writable sheets
	 */
	public class ReadFormulaRecord : CellValue, FormulaData
		{
		/**
		 * The logger
		 */
		...
		public byte[] getFormulaData()
			...
			System.Array.Copy(d, 0, data, 0, d.Length);
		...
		public byte[] getFormulaBytes()
			...
			System.Array.Copy(readFormulaData, 16, formulaBytes, 0, formulaBytes.Length);
			return formulaBytes;
			}
		...
		public override void rowInserted(Sheet s, int sheetIndex, int row)
			...
			try
				...
				{
				//logger.warn("cannot insert row within formula:  " + e.Message);
				}
			}
