...
namespace CSharpJExcel.Jxl.Write.Biff
	 ...
	 * File
	 */
	class BOFRecord : WritableRecordData
		{
		/**
		...
		public sealed class WorkbookGlobalsBOF 
			{ 
			};

		public static readonly WorkbookGlobalsBOF workbookGlobals = new WorkbookGlobalsBOF();

		public sealed class SheetBOF 
			{ 
			};

		public static readonly SheetBOF sheet = new SheetBOF();
