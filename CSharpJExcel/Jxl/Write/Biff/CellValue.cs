...
namespace CSharpJExcel.Jxl.Write.Biff
	 ...
	 * data store
	 */
	public abstract class CellValue : WritableRecordData, WritableCell
		{
		/**
		 * The logger
		 */
		 ...
		 */
		public virtual void columnInserted(Sheet s, int sheetIndex, int col)
			{
			}
		 ...
		 * @param col the column number which was inserted
		 */
		public virtual void columnRemoved(Sheet s, int sheetIndex, int col)
			{
			}
		 ...
		 */
		public virtual void rowInserted(Sheet s, int sheetIndex, int row)
			{
			}
		 ...
		 */
		public virtual void rowRemoved(Sheet s, int sheetIndex, int row)
			{
			}
		 ...
		 */
		public void removeCellFeatures()
			{
			/*
			// Remove the comment
		 ...
		 *
		 * @param bool the copied flag
		 */
		public void setCopied(bool c)
			{
			copied = c;
			}
		 ...
		 */
		public abstract WritableCell copyTo(int col, int row);
