...
namespace CSharpJExcel.Jxl.Write
	 ...
	 */
	public class WritableCellFeatures : CellFeatures
		{
		// shadow the conditions in the base class so that they appear on
		// the public generated javadoc
		public static readonly ValidationCondition BETWEEN = BaseCellFeatures.BETWEEN;
		public static readonly ValidationCondition NOT_BETWEEN = BaseCellFeatures.NOT_BETWEEN;
		public static readonly ValidationCondition EQUAL = BaseCellFeatures.EQUAL;
		public static readonly ValidationCondition NOT_EQUAL = BaseCellFeatures.NOT_EQUAL;
		public static readonly ValidationCondition GREATER_THAN = BaseCellFeatures.GREATER_THAN;
		public static readonly ValidationCondition LESS_THAN = BaseCellFeatures.LESS_THAN;
		public static readonly ValidationCondition GREATER_EQUAL = BaseCellFeatures.GREATER_EQUAL;
		public static readonly ValidationCondition LESS_EQUAL = BaseCellFeatures.LESS_EQUAL;
		 ...
		 * @param s the comment
		 */
		public override void setComment(string s)
			{
			base.setComment(s);
			}
		 ...
		 */
		public override void setComment(string s, double width, double height)
			{
			base.setComment(s, width, height);
			}

		/**
		 * Removes the cell comment, if present
		 */
		public override void removeComment()
			{
			base.removeComment();
			}
		 ...
		 */
		public override void removeDataValidation()
			{
			base.removeDataValidation();
			}
		 ...
		 */
		public override void setDataValidationList(IList c)
			{
			base.setDataValidationList(c);
			}
		 ...
		 */
		public override void setDataValidationRange(int col1, int row1, int col2, int row2)
			{
			base.setDataValidationRange(col1, row1, col2, row2);
			}

		/**
		 * Sets the data validation based upon a named range.  If the namedRange
		 * is an empty string (string.Empty) then the cell is effectively made read only
		 *
		 * @param namedRange the workbook named range defining the validation 
		 *                   boundaries
		 */
		public override void setDataValidationRange(string namedRange)
			{
			base.setDataValidationRange(namedRange);
			}
		 ...
		 */
		public override void setNumberValidation(double val, ValidationCondition c)
			{
			base.setNumberValidation(val, c);
			}
