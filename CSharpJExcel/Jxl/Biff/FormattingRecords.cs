...
namespace CSharpJExcel.Jxl.Biff
	...
	public class FormattingRecords
		 ...
		 * in a spreadsheet
		 */
		private Dictionary<int,object> formats;
		...
		public FormattingRecords(Fonts f)
			...
			formats = new Dictionary<int,object>(10);
		...
		public FormatRecord getFormatRecord(int index)
			...
			if (!formats.ContainsKey(index))
				return null;
			return formats[index] as FormatRecord;
			}
		...
		public void write(File outputFile)
			...
			foreach (FormatRecord fr in formatsList)
				outputFile.write(fr);
		 ...
		 */
		public int getNumberOfFormatRecords()
			{
