...
//		public static Logger logger = Logger.getLogger(BaseCellFeatures.class);
		...
		// Constants
		private const double defaultCommentWidth = 3;
		private const double defaultCommentHeight = 4;
		...
		public static readonly ValidationCondition BETWEEN = new ValidationCondition(DVParser.BETWEEN);
		public static readonly ValidationCondition NOT_BETWEEN = new ValidationCondition(DVParser.NOT_BETWEEN);
		public static readonly ValidationCondition EQUAL = new ValidationCondition(DVParser.EQUAL);
		public static readonly ValidationCondition NOT_EQUAL = new ValidationCondition(DVParser.NOT_EQUAL);
		public static readonly ValidationCondition GREATER_THAN = new ValidationCondition(DVParser.GREATER_THAN);
		public static readonly ValidationCondition LESS_THAN = new ValidationCondition(DVParser.LESS_THAN);
		public static readonly ValidationCondition GREATER_EQUAL = new ValidationCondition(DVParser.GREATER_EQUAL);
		public static readonly ValidationCondition LESS_EQUAL = new ValidationCondition(DVParser.LESS_EQUAL);
		 ...
		 */
		public void setWritableCell(CellValue wc)
			{
			writableCell = wc;
			}
		 ...
		 */
		public virtual void setComment(string s, double width, double height)
			{
			comment = s;
			commentWidth = width;
		 ...
		 */
		public virtual void removeSharedDataValidation()
			{
			if (!dataValidation)
				{
				return;
		 ...
		 */
		public virtual void setCommentDrawing(Comment c)
			{
			commentDrawing = c;
			}
		 ...
		 */
		public virtual Comment getCommentDrawing()
			{
		 ...
		 */
		public virtual string getDataValidationList()
			{
		 ...
		 */
		public virtual void setDataValidationList(IList c)
			{
		 ...
		 * @param c the list of valid values
		 */
		public virtual void setDataValidationRange(int col1, int r1, int col2, int r2)
			{
			if (dataValidation && getDVParser().extendedCellsValidation())
				{
				//logger.warn("Cannot set data validation on " +
		 ...
		 * @return TRUE if this has a data validation associated with it,
				   FALSE otherwise
		*/
		public virtual bool hasDataValidation()
			{
