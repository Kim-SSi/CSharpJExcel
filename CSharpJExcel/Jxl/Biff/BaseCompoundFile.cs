...
namespace CSharpJExcel.Jxl.Biff
	...
	public abstract class BaseCompoundFile
		 ...
		 */
		protected static readonly byte[] IDENTIFIER = new byte[]
				{
				(byte) 0xd0,
				(byte) 0xcf,
				(byte) 0x11,
		...
		/**
		 */
		protected const int NUM_BIG_BLOCK_DEPOT_BLOCKS_POS = 0x2c;
		/**
		 */
		protected const int SMALL_BLOCK_DEPOT_BLOCK_POS = 0x3c;
		/**
		 */
		protected const int NUM_SMALL_BLOCK_DEPOT_BLOCKS_POS = 0x40;
		/**
		 */
		protected const int ROOT_START_BLOCK_POS = 0x30;
		/**
		 */
		protected const int BIG_BLOCK_SIZE = 0x200;
		/**
		 */
		protected const int SMALL_BLOCK_SIZE = 0x40;
		/**
		 */
		protected const int EXTENSION_BLOCK_POS = 0x44;
		/**
		 */
		protected const int NUM_EXTENSION_BLOCK_POS = 0x48;
		/**
		 */
		protected const int PROPERTY_STORAGE_BLOCK_SIZE = 0x80;
		/**
		 */
		protected const int BIG_BLOCK_DEPOT_BLOCKS_POS = 0x4c;
		/**
		 */
		protected const int SMALL_BLOCK_THRESHOLD = 0x1000;
		...
		/**
		*/
		private const int COLOUR_POS = 0x43;
		/**
		 */
		...
		/**
		 */
		private const int CHILD_POS = 0x4c;
		/**
		 */
		 ...
		 */
		public const string ROOT_ENTRY_NAME = "Root Entry";
		public const string WORKBOOK_NAME = "Workbook";
		public const string SUMMARY_INFORMATION_NAME = "\u0005SummaryInformation";
		public const string DOCUMENT_SUMMARY_INFORMATION_NAME = "\u0005DocumentSummaryInformation";
		public const string COMP_OBJ_NAME = "\u0001CompObj";
		public static readonly string[] STANDARD_PROPERTY_SETS = new string[] 
					{
					ROOT_ENTRY_NAME, 
					WORKBOOK_NAME,
		 ...
		 */
		public const int NONE_PS_TYPE = 0;
		public const int DIRECTORY_PS_TYPE = 1;
		public const int FILE_PS_TYPE = 2;
		public const int ROOT_ENTRY_PS_TYPE = 5;
