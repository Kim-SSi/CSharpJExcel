...
namespace CSharpJExcel.Jxl.Biff.Formula
	 ...
	 */
	abstract class SubExpression : Operand,ParsedThing
		{
		/**
		 ...
		 */
		public virtual int read(byte[] data,int pos)
			{
		...
		public virtual void setLength(int l)
			{
			length = l;
			}
		...
		public virtual ParseItem[] getSubExpression()
			{
