...
namespace CSharpJExcel.Jxl.Biff.Formula
	...
	public abstract class ParseItem
		 ...
		 */
		public abstract void getString(StringBuilder buf);
		 ...
		 * column was inserted, FALSE otherwise
		 */
		public abstract void columnRemoved(int sheetIndex,int col,bool currentSheet);
		 ...
		 * column was inserted, FALSE otherwise
		 */
		public abstract void rowInserted(int sheetIndex, int row, bool currentSheet);
		 ...
		 * column was inserted, FALSE otherwise
		 */
		public abstract void rowRemoved(int sheetIndex, int row, bool currentSheet);
