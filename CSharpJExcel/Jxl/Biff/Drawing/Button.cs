...
namespace CSharpJExcel.Jxl.Biff.Drawing
	 ...
	 */
	public class Button : DrawingGroupObject
		{
		/**
		 * The logger
		 */
		 ...
		 */
		public virtual void setTextobject(TextobjectRecord t)
			{
			txo = t;
			}
		 ...
		 */
		public virtual void setText(ContinueRecord t)
			{
			text = t;
			}
		 ...
		 */
		public virtual void setFormatting(ContinueRecord t)
			{
			formatting = t;
			}
		...
		public override int GetHashCode()
			{
			return commentText.GetHashCode();
			}
		 ...
		 */
		public virtual void setButtonText(string t)
			{
			commentText = t;
