...
namespace CSharpJExcel.Jxl.Biff
	...
	public class DoubleHelper
		...
		public static double getIEEEDouble(byte[] data,int pos)
			...
			bool negative = ((num2 & 0x80000000) != 0);
			...
			double value = System.BitConverter.Int64BitsToDouble(val);
		...
		public static void getIEEEBytes(double d,byte[] target,int pos)
			{
			long val = System.BitConverter.DoubleToInt64Bits(d);
			...
			target[pos + 7] = (byte)(((ulong)val & 0xff00000000000000L) >> 56);
			}
		}
	}
