...
namespace CSharpJExcel.Jxl.Biff
	...
	public class FontRecord : WritableRecordData, Font
		 ...
		 */
		public FontRecord(string fn, int ps, int bold, bool it,int us,int ci,int ss)
			: base(Type.FONT)
			{
			boldWeight = bold;
			underlineStyle = us;
		 ...
		 */
		protected void setFontItalic(bool i)
			{
			Assert.verify(!initialized);
		 ...
		 */
		public virtual bool isStruckout()
			{
			return struckout;
			}
		 ...
		 */
		protected void setFontStruckout(bool os)
			{
			struckout = os;
			}
		}
